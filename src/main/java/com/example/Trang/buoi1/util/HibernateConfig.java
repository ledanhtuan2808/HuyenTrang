package com.example.Trang.buoi1.util;
...
public class HibernateConfig {
    ...
    static {
        ...
        properties.put(Environment.URL, "jdbc:sqlserver://localhost:1433;databaseName=sd21101sof3062;encrypt=true;trustServerCertificate=true;");
